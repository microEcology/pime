...
#'
#' Partial dataset analysed on the article "Differences in bacterial composition between men’s and women’s restrooms and other common areas within a public building"
#' 'DOI: 10.1007/s10482-017-0976-6'. Contains microbial composition of dut samples from man's and women's restrooms in a public building from Brazil.
#'
#'
...
#'   \item{Floor}{Which flor samples were taken}
